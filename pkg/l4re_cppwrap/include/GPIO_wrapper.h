...
void GPIO_Device_destroy(void** device);// REVIEW 
void GPIO_Device_show_info(void* device);
...
bool GPIO_Device_DiscretRead(void * device, unsigned channel, uint32_t * data);
