...
private:
  ...
  // free_peer_req_callback_t free_your_data_handler; // handel free data req. from the other side
public:
  ...
  DS_Side(
    ...
    free_peer_req_callback_t free_peer_req_callback = nullptr // handle free data req. from the other side
  ) 
  {
    if (server != nullptr && this_side_ipc_name != nullptr)
    {
        ...
        this_side_ipc_name,
        new_data_callback,
        free_peer_req_callback // handle free data req. from the other side
